...
<link rel="dns-prefetch" href="//fonts.bunny.net">
 ...
 <table class="table table-bordered" style="width:100%">
    ...
    <tbody >
        ...
        <tr>
            <th  style="width:20%;">Date</th><td>{{$students[0]->date}}</td><th>Hall</th><td colspan='3'><centre> <b>{{$hall}}</b><centre></td> 
        </tr>
        <tr>
        <th>Session</th><td>{{$students[0]->session}}</td><th style="width:20%">name of the Invigilator</th><td  colspan='3'></td> 
        </tr>
